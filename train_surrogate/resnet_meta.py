...
# class DataParallel(MetaModule):
#     def __init__(self, module):
#         super(DataParallel, self).__init__()
#         self.module = module

#     def forward(self, input):
#         return nn.parallel.data_parallel(self.module, input)

#     def named_params(self):
#         return self.module.named_params()
...
class ResNet(MetaModule):
    def __init__(self,block, num_blocks, in_channel=3, **kwargs):
        ...
        self.fc = MetaLinear(512*block.expansion, kwargs['num_classes'])
...
def MetaResNet18(**kwargs):
    return ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)


def MetaResNet34(**kwargs):
    return ResNet(BasicBlock, [3, 4, 6, 3], **kwargs)


def MetaResNet50(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)


def MetaResNet101(**kwargs):
